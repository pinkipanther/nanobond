 ...
 *         ERC-20 token with raise, holder rewards, and creator APR mechanics.
 */
contract NanoBondFactory {
     ...
     * @param _hardCap        Maximum HBAR to raise (in tinybars)
     * @param _softCap        Minimum HBAR to raise (in tinybars)
    ...
    function createBond(
        ...
        require(_yieldRateBps > 0 && _yieldRateBps <= 50000, "NanoBondFactory: invalid yield rate"); // Max 500% APR
