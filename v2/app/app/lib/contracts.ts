...
export const HEDERA_JSON_RPC_URL =
  publicEnv(process.env.NEXT_PUBLIC_HEDERA_JSON_RPC_URL) ??
  (HEDERA_NETWORK === "mainnet"
    ? "https://mainnet.hashio.io/api"
    : "https://testnet.hashio.io/api");

export const HEDERA_MIRROR_NODE_URL =
  publicEnv(process.env.NEXT_PUBLIC_HEDERA_MIRROR_NODE_URL) ??
  (HEDERA_NETWORK === "mainnet"
    ? "https://mainnet.mirrornode.hedera.com"
    : "https://testnet.mirrornode.hedera.com");

export const CONTRACTS = {
  FACTORY: publicEnv(process.env.NEXT_PUBLIC_NANOBOND_FACTORY_ADDRESS) ?? "",
  PRO_FACTORY: publicEnv(process.env.NEXT_PUBLIC_NANOPRO_FACTORY_ADDRESS) ?? "",
  CURVE: publicEnv(process.env.NEXT_PUBLIC_NANOBOND_CURVE_ADDRESS) ?? "",
  CURVE_TOKEN: publicEnv(process.env.NEXT_PUBLIC_NANOBOND_CURVE_TOKEN_ADDRESS) ?? "",
};
